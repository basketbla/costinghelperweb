...
function App() {
  ...
  const downloadResults = () => {
    ...
    for (let chunk of returnData) {
      ...
      if (includeME) {
        returnString += "\n";
        returnString += "Margin of error for 95% confidence level (including shipping): " + chunk.value.marginError + "%\n";
        returnString += "Margin of error for 95% confidence level (excluding shipping): " + chunk.value.marginErrorNoShipping + "%\n";
      }
      if (includeCL) {
        returnString += "\n";
        returnString += "Two-sided Z-score for 5% margin of error (including shipping): " + chunk.value.zScore + "\n";
        returnString += "Two-sided Z-score for 5% margin of error (excluding shipping): " + chunk.value.zScoreNoShipping + "\n";
      }
      if (includeSS) {
        returnString += "\n";
        returnString += "Sample size for 5% margin of error and 95% confidence level (including shipping): " + chunk.value.sampleSize + "\n";
        returnString += "Sample size for 5% margin of error and 95% confidence level (excluding shipping): " + chunk.value.sampleSizeNoShipping + "\n";
      }
      returnString += "\n";
      ...
      <div className="section black" id="help">
        <div className="text-container">
          ...
          <ul>
            ...
            <li>
              Google Shopping gives about 20 results a page, so a requesting higher numbers of results may take much longer to run.
            </li>
            <li>
              The 'total results' output might not match the number you're able to get. Again, don't panic -- this is just Google Shopping
